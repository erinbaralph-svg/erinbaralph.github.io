      ...
      <main className="bg-[#410142] overflow-y-auto flex flex-col flex-grow">
        ...
        <div className="flex items-center min-h-fit gap-4 p-4 bg-[#D5D1C8]">
          <div className="w-full text-lg h-fit flex flex-col gap-1 items-center max-w-[50ch]">
            <p className="bg-white px-3 py-2 border-1 border-black/30">
              ...
              assist museums and archives in their activities and operations.
              Feel free to explore my site a bit further to learn more about me
          ...
          <div className="w-full h-full bg-white p-4 gap-3 flex flex-col items-center justify-center border-1 border-black/30">
            ...
            <p className="italic text-sm">
              Picture of me working the needlework booth at the Lynde House Museum's Annual
              History In The Park.
            </p>
          </div>
        </div>
