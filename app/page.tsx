...
export default function Home() {
  return (
    <main className="bg-[#410142] overflow-y-auto flex flex-col flex-grow">
      <h1 className="text-yellow-100 text-2xl p-4">Get To Know Me!</h1>
      <div className="flex items-center min-h-fit gap-4 p-4 bg-[#D5D1C8]">
        <div className="w-full text-lg h-fit flex flex-col gap-1 items-center max-w-[50ch]">
          <p className="bg-white px-4 py-3">
            ...
            public programming for many groups of all ages and abilities. I also
            have experience with exhibit design, research, budgeting, and
            planning. I have undertaken multiple large-scale archives and
            collections overhaul projects at various institutions.
            <br />
            <br />I have a great deal of interest in using digital media to
            assist museums and archives in their activities and operations. Feel
            free to explore my site a bit further to learn more about me and
            what I have worked on!
          </p>
        </div>
        <div className="w-full h-full bg-white p-4 gap-2 flex flex-col items-center justify-center">
